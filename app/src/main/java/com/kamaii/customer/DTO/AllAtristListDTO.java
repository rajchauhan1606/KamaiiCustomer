...
public class AllAtristListDTO implements Serializable {
    ...
    public String getSub_category_id2() {
        return sub_category_id2;
    }

    public void setSub_category_id2(String sub_category_id2) {
        this.sub_category_id2 = sub_category_id2;
    }
    ...
    public String getIconthirdcat() {
        return iconthirdcat;
    }

    public void setIconthirdcat(String iconthirdcat) {
        this.iconthirdcat = iconthirdcat;
    }
