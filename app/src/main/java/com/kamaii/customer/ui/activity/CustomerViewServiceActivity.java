...
import com.kamaii.customer.ui.adapter.ReferCustomerServiceAdapter;
import com.kamaii.customer.ui.models.ReferServiceModel;
import com.kamaii.customer.ui.models.customerservicemodel;
...
public class CustomerViewServiceActivity extends AppCompatActivity {
    ...
    private  void shodata(){
        ...
        if(referServiceModel.getTotal_commision().equalsIgnoreCase("null")){
            tv_total_commsion.setText("Total Commsion : 0");
        }else {
            tv_total_commsion.setText("Total Commsion : "+referServiceModel.getTotal_commision());
        }
